...
SUB_PATH = os.environ.get('SUB_PATH', 'vml')           # 订阅token,默认sub，例如：https://www.google.com/sub
UUID = os.environ.get('UUID', 'b4c1429f-abb8-41ad-bd6e-89e568a23143')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'wasmrsbcf.aryua1.bond')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiM2NlMmVhYzdiZmRjNjk3YTc1NDI0YjNjZjNhMWU3ZTAiLCJ0IjoiZjNkOTFhMjQtNTAyZS00ZTVlLTlhNGEtZjRkMDFmODBhMjlmIiwicyI6IllUYzJPVEl3TTJNdE1qVTFOaTAwTm1ZeExXSTJORFF0TURoak16WXlNVFZoT1dRMCJ9')            # Argo固定隧道密钥,留空即使用临时隧道
